        ...
        <div className="container-width">
          <div className="flex justify-between items-center h-20">
            ...
            <Link href="/" className="flex items-center gap-2.5 group">
              ...
              <img src="/logo.png" alt="Driveway Gates Hertfordshire" className="h-10 w-auto" />
              <div className="flex flex-col">
                <span className="font-display font-bold text-xl leading-none text-gray-900">Driveway Gates</span>
                <span className="text-xs text-brand-500 font-semibold tracking-widest uppercase">Hertfordshire</span>
              </div>
            </Link>
