...
export const CITY_INTROS: Record<string, CityIntro> = {
  ...
  'standon': {
    ...
    intros: {
      ...
      'gate-repair-and-maintenance': [
        'The Standon gate stock includes a substantial base of 1990s and 2000s electric gate installations, most still repairable with current spare parts. FAAC, BFT, and CAME units from that period are routinely restored to full function for a fraction of the replacement cost, and a technician who diagnoses honestly identifies the actual failure rather than quoting wholesale replacement.',
  ...
  'markyate': {
    ...
    intros: {
      ...
      'gate-repair-and-maintenance': [
        'The Markyate gate stock includes a substantial base of 1990s and 2000s electric gate installations, most still repairable with current spare parts. FAAC, BFT, and CAME units from that period are routinely restored to full function for a fraction of the replacement cost, and a technician who diagnoses honestly identifies the actual failure rather than upselling to wholesale replacement.',
  ...
  'chipperfield': {
    ...
    intros: {
      ...
      'gate-repair-and-maintenance': [
        'Chipperfield has a meaningful base of 1990s and 2000s electric gate installations, most repairable with current spare parts. FAAC, BFT, and CAME units from that period are routinely restored to full function, and a technician who diagnoses honestly saves most owners thousands compared to replacement quotations. Getting a second opinion before accepting wholesale replacement is the single most valuable action owners can take.',
  ...
  'pirton': {
    ...
    intros: {
      ...
      'automated-gate-systems': [
        'Pirton gate automation projects typically involve motorising existing manual gates on period and rural properties where mechanical operation has become inconvenient. The diagnostic question on any retrofit is load capacity of the existing frame and piers, and older Pirton properties occasionally require pier reinforcement before underground motor chambers can be excavated responsibly.',
  ...
  'walkern': {
    ...
    intros: {
      ...
      'wooden-driveway-gates': [
        'Hardwood suits Walkern\'s village vocabulary comfortably. Oak, iroko, and Accoya are the standard specifications across quality installations, and East Hertfordshire District Council planning officers typically approve timber applications with fewer conditions than metal equivalents within the conservation area. The design vocabulary tends toward restrained boarded or framed-and-panelled forms rather than ornamental work.',
      ...
      'automated-gate-systems': [
        'Walkern automation retrofits commonly involve motorising existing manual gates on period properties across the village. The load capacity of existing frames and piers is the critical diagnostic question on every retrofit, and older properties sometimes require pier reinforcement before underground motor chambers can be excavated responsibly. Honest surveys identify these requirements upfront rather than after deposit.',
        'Cable routing across the substantial plot sizes typical of the village is the common install challenge. Mains distances from consumer unit to gate position often exceed 25 metres, and the established landscaping makes disruptive trenching unacceptable. Directional boring or careful routing through existing service corridors adds cost but preserves the garden investment.',
      ],
      'gate-repair-and-maintenance': [
        'Walkern has a substantial base of 1990s and 2000s electric gate installations, most repairable with current spare parts. FAAC, BFT, and CAME units from that period are routinely restored to full function, and a technician who diagnoses honestly saves most owners thousands compared to replacement quotations. Getting a second opinion before accepting wholesale replacement is the single most valuable action owners can take.',
    ...
    cityIntro: [
      ...
      'Our Walkern installer network includes specialists with genuine village track records and documented East Herts planning experience. Every referred installer has completed at least six verifiable Walkern or immediately adjacent projects before receiving any enquiry, and understands the design sensibilities that successful conservation area applications require.',
    ],
  },
  ...
  'benington': {
    ...
    intros: {
      ...
      'metal-driveway-gates': [
        ...
        'Specification quality matters substantially on exposed Benington plots. Hot-dip galvanising before polyester powder coating delivers 20-30 year finish performance in the local microclimate, and paint-only finishes fail predictably within a decade. Real forge work rather than cold-bent mild steel dressed as wrought iron is worth paying for explicitly on period property installations in the village.',
      ],
      'automated-gate-systems': [
        'Benington automation retrofits commonly involve motorising existing manual gates on the substantial period property stock across the village. The load capacity of existing frames and piers is the critical diagnostic on every retrofit, and older Benington properties occasionally require pier reinforcement before underground motor chambers can be excavated properly.',
      ...
      'gate-repair-and-maintenance': [
        'The Benington gate stock includes a substantial base of 1990s and 2000s electric gate installations, most still repairable with current spare parts. FAAC, BFT, and CAME units from that period are routinely restored to full function for a fraction of the replacement cost, and a technician who diagnoses honestly identifies the actual failure rather than quoting wholesale replacement.',
        'Benington failure patterns track the local microclimate and the clay substrate across the parish. Photocell drift from seasonal ground movement, control board corrosion where original drainage was under-specified, and hinge bearing wear from heavy cycling appear repeatedly in local records. All are repairable conditions given proper diagnostic work.',
      ],
    },
    cityIntro: [
  ...
  'gaddesden': {
    ...
    intros: {
      ...
      'gate-repair-and-maintenance': [
        'The Gaddesden gate stock includes a substantial base of 1990s and 2000s electric gate installations, most still repairable with current spare parts. FAAC, BFT, and CAME units from that period are routinely restored to full function for a fraction of the replacement cost, and a technician who diagnoses honestly identifies the actual failure rather than upselling to wholesale replacement.',
  ...
  'south-mimms': {
    ...
    intros: {
      ...
      'automated-gate-systems': [
        ...
        'Cable routing is the common South Mimms install challenge. Plot sizes across the village mean mains distances from consumer unit to gate often exceed 25 metres, and the established landscaping makes disruptive trenching unacceptable. Directional boring or careful routing through existing service corridors adds cost but preserves garden investment.',
      ],
      'gate-repair-and-maintenance': [
        'The South Mimms gate stock includes a substantial base of 1990s and 2000s electric gate installations, most still repairable with current spare parts. FAAC, BFT, and CAME units from that period are routinely restored to full function for a fraction of the replacement cost, and a technician who diagnoses honestly identifies the actual failure rather than upselling to wholesale replacement.',
  ...
  'ridge': {
    ...
    intros: {
      ...
      'wooden-driveway-gates': [
        ...
        'For plots within the curtilage of listed buildings across the village core, listed building consent may be required alongside planning permission, and documentation standards are higher. Proper installers price these planning costs transparently at quotation rather than absorbing them later. Bespoke fabrication with 6-10 week lead times is the rule at the Ridge specification level.',
      ],
      'metal-driveway-gates': [
        ...
        'Specification quality separates lasting installations from cheaper alternatives. Hot-dip galvanising before polyester powder coating delivers 20-30 year finish performance in the local microclimate, and paint-only finishes fail predictably within a decade. Real forge work rather than cold-bent mild steel dressed as wrought iron is the key distinction on period property installations and worth specifying explicitly in writing.',
      ],
      'automated-gate-systems': [
      ...
      'gate-repair-and-maintenance': [
        ...
        'Ridge failure patterns track the clay substrate and rural microclimate. Photocell drift from seasonal ground movement, control board corrosion from water ingress where drainage was under-specified, and tree-root displacement of underground motor chambers all appear repeatedly in local repair records. All are repairable conditions given proper diagnostic work.',
      ],
    },
    cityIntro: [
  ...
  'lemsford': {
    ...
    intros: {
      ...
      'automated-gate-systems': [
        ...
        'Cable routing across the mature Lemsford gardens is the common install challenge. Plot sizes and the landscaping quality across the village mean disruptive trenching is usually unacceptable, and directional boring or careful routing through existing service corridors adds to the installation budget. Proper installers price this work transparently at quotation stage.',
      ],
      'gate-repair-and-maintenance': [
        'The Lemsford gate stock includes a substantial base of 1990s and 2000s electric gate installations, most still repairable with current spare parts. FAAC, BFT, and CAME units from that period are routinely restored to full function, and a technician who diagnoses honestly identifies the actual failure rather than upselling to wholesale replacement.',
  ...
  'hunsdon': {
    ...
    intros: {
      ...
      'metal-driveway-gates': [
        ...
        'Specification quality is non-negotiable on exposed Hunsdon plots. Hot-dip galvanising before polyester powder coating delivers 20-30 year finish performance in the local microclimate, and cheaper paint-only finishes fail within a decade. Real forge work rather than cold-bent mild steel dressed as wrought iron is the key distinction on period property installations and worth paying for explicitly.',
      ],
      'automated-gate-systems': [
      ...
      'gate-repair-and-maintenance': [
        'Hunsdon has a substantial base of 1990s and 2000s electric gate installations, most repairable with current spare parts. FAAC, BFT, and CAME units from that period are routinely restored to full function, and a technician who diagnoses honestly saves most owners thousands compared to replacement quotations. Getting a second opinion before accepting wholesale replacement is the single most valuable action owners can take.',
  ...
  'st-ippolyts': {
    ...
    intros: {
      ...
      'wooden-driveway-gates': [
        ...
        'North Hertfordshire District Council planning officers typically approve timber gate applications in St Ippolyts with fewer conditions than metal specifications, particularly within the conservation boundary. Bespoke fabrication with 6-10 week lead times is the rule at this price point, and the silvering of oak to a soft grey over the first few seasons integrates well with the weathered brick of established village boundary treatments.',
      ],
      'metal-driveway-gates': [
        ...
        'Specification quality separates honest installations from cheaper alternatives. Hot-dip galvanising followed by polyester powder coating is the baseline specification that delivers a 20-30 year finish in St Ippolyts\' Chilterns-edge climate, and anything less produces rust breakthrough within a decade. Real forge work rather than cold-bent mild steel dressed as wrought iron is the key distinction worth paying for on any period property installation.',
      ],
      'automated-gate-systems': [
        'St Ippolyts gate automation projects typically involve motorising existing manual gates on period and rural properties where mechanical operation has become inconvenient. The diagnostic question on any retrofit is load capacity of the existing frame and piers, and older St Ippolyts properties occasionally require pier reinforcement before underground motor chambers can be excavated responsibly.',
        'The common St Ippolyts install challenge is cable routing across the substantial plot sizes typical of the village. Mains distances from consumer unit to gate position routinely exceed 25 metres, and the established landscaping across the village makes disruptive trenching unacceptable. Directional boring or careful routing through existing service corridors adds cost but preserves garden investment.',
      ],
      'gate-repair-and-maintenance': [
        'St Ippolyts has a meaningful base of 1990s and 2000s electric gate installations, most repairable with current spare parts. FAAC, BFT, and CAME units installed fifteen to twenty years ago are routinely restored to full function, and a technician who diagnoses honestly saves most owners thousands of pounds compared to replacement quotations.',
        'Local failure patterns in St Ippolyts track the mixed chalk-and-clay substrate and the Chilterns-edge microclimate conditions. Photocell drift from seasonal ground movement, control board corrosion from water ingress after drainage failures, and hinge bearing wear from heavy cycling appear repeatedly in local repair records. All are repairable conditions given proper diagnostic work rather than upselling.',
      ],
    },
    cityIntro: [
  ...
  'weston': {
    ...
    intros: {
      ...
      'automated-gate-systems': [
        'Weston automation retrofits commonly involve motorising existing manual gates on the substantial period property stock across the village. The load capacity of existing frames and piers is the critical diagnostic on every retrofit, and older Weston properties occasionally require pier reinforcement before underground motor chambers can be excavated properly.',
        'Cable routing is the common Weston install challenge. Plot sizes across the village mean mains distances from consumer unit to gate often exceed 25 metres, and the established landscaping makes disruptive trenching unacceptable. Directional boring or careful routing through existing service corridors adds cost but preserves garden investment.',
      ],
      'gate-repair-and-maintenance': [
        'The Weston gate stock includes a substantial base of 1990s and 2000s electric gate installations, most still repairable with current spare parts. FAAC, BFT, and CAME units from that period are routinely restored to full function for a fraction of the replacement cost, and a technician who diagnoses honestly identifies the actual failure rather than quoting wholesale replacement.',
  ...
  'ardeley': {
    ...
    intros: {
      'electric-sliding-gates': [
        ...
        'Foundation detail on Ardeley\'s clay-dominated substrate requires proper specification. Cantilever sliding systems demand substantial concrete footings with correct drainage, and short-cut foundations produce gates that drift and bind within a few winters on clay ground. The rectification cost usually exceeds any original saving substantially, and honest contractors identify these requirements at survey rather than after installation.',
      ],
      'electric-swing-gates': [
      ...
      'gate-repair-and-maintenance': [
        'The Ardeley gate stock includes a meaningful base of 1990s and 2000s electric gate installations, most still repairable with current spare parts. FAAC, BFT, and CAME units from that period are routinely restored to full function, and a technician who diagnoses honestly identifies the actual failure rather than quoting wholesale replacement. Second opinions before accepting replacement quotes save most owners substantial sums.',
        'Ardeley failure patterns track the local microclimate and the clay substrate across the parish. Photocell drift from seasonal ground movement, control board corrosion where original drainage was under-specified, and hinge bearing wear from heavy cycling appear repeatedly in local records. All are repairable conditions given proper diagnostic work.',
      ],
    },
    cityIntro: [
  ...
  'stanborough': {
    ...
    intros: {
      ...
      'gate-repair-and-maintenance': [
        'The Stanborough gate stock includes a substantial base of 1990s and 2000s electric gate installations, most still repairable with current spare parts. FAAC, BFT, and CAME units from that period are routinely restored to full function, and a technician who diagnoses honestly identifies the actual failure rather than upselling to wholesale replacement.',
  ...
  'little-hadham': {
    ...
    intros: {
      ...
      'electric-swing-gates': [
        ...
        'Swing clearance surveys are particularly important in Little Hadham\'s historic core. The old plot patterns produced restricted frontage widths and irregular boundary geometries, and swing arcs need physical verification rather than paper calculation. Any installer quote for a Little Hadham swing gate that relies solely on opening dimensions rather than an on-site swing path survey should be questioned before acceptance.',
      ],
      'wooden-driveway-gates': [
      ...
      'automated-gate-systems': [
        ...
        'Cable routing across the mature Little Hadham gardens is the common install challenge. Plot sizes and the landscaping quality across the village mean disruptive trenching is usually unacceptable, and directional boring or careful routing through existing service corridors adds to the installation budget. Proper installers price this work transparently at quotation stage.',
      ],
      'gate-repair-and-maintenance': [
  ...
  'graveley': {
    ...
    intros: {
      ...
      'automated-gate-systems': [
        ...
        'Cable routing is the common Graveley install challenge. Plot sizes across the village mean mains distances from consumer unit to gate often exceed 25 metres, and the established landscaping makes disruptive trenching unacceptable. Directional boring or careful routing through existing service corridors adds cost but preserves garden investment.',
      ],
      'gate-repair-and-maintenance': [
        'The Graveley gate stock includes a substantial base of 1990s and 2000s electric gate installations, most still repairable with current spare parts. FAAC, BFT, and CAME units from that period are routinely restored to full function for a fraction of the replacement cost, and a technician who diagnoses honestly identifies the actual failure rather than quoting wholesale replacement.',
